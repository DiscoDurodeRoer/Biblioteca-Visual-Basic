Public Class ListaNumeros
    ...
    '---------------------------------------------
    Public Sub Insertar_Primero(ByVal m As Integer)
    ...
    '---------------------------------------------
    Public Sub Insertar_Ultimo(ByVal m As Integer)
    ...
    '---------------------------------------------
    Public Function Dev_Ultimo() As Integer
    ...
    Public Sub Insertar_posicion(ByVal pos As Integer, ByVal m As Integer)
    ...
    Public Function devYBorrarPrimero() As Integer
    ...
    Public Function existeNumero(ByVal numeroBuscado As Integer) As Boolean
        ...
        While Not IsNothing(aux) And Not existe

            If aux.dato = numeroBuscado Then
                existe = True
            End If
