Public Class Lista_Personajes
    ...
    Public Class Nodo
        ...
        Public Sub New(ByVal m As Personajes)
            sig = Nothing
            dato = m
        End Sub
    End Class
    ...
    '---------------------------------------------
    Public Sub Insertar_Primero(ByVal m As Personajes)
    ...
    '---------------------------------------------
    Public Sub Insertar_Ultimo(ByVal m As Personajes)
    ...
    '---------------------------------------------
    Public Function Dev_Ultimo() As Personajes

        Dim elemen As Personajes = Nothing
    ...
    '---------------------------------------------
    Public Function Dev_Primero() As Personajes
    ...
    Public Sub Insertar_posicion(ByVal pos As Integer, ByVal m As Personajes)
    ...
    Public Function devuelveMuestraPosicion(ByVal posicion As Integer) As Muestra


        Dim elemen As Muestra = Nothing
        Dim aux As Nodo = Nothing
    ...
    Public Function devYBorrarPrimero() As Muestra

        Dim m As Muestra = Dev_Primero()
        Quitar_Primero()
    ...
    Public Sub rellenObjetos(ByVal limite As Integer)
        ...
        While i < NUMERO_MUESTRAS
            Insertar_Ultimo(New Muestra("muestra " & i))
            i += 1
        End While
